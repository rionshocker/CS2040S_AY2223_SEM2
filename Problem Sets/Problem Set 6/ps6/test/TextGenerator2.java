...
public class TextGenerator2 {
    ...
    public static String buildModel(int order, String fileName, MarkovModel2 model) {
        ...
        try {
            ...
            if (MarkovModel2.countNoOfWords(text.toString()) < order) {
    ...
    public static void main(String[] args) {
        ...
        // Create the model
        MarkovModel2 markovModel = new MarkovModel2(order, seed);
